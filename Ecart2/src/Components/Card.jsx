...
let darkTheme = "card bg-slate-600 w-96 shadow-xl m-4 text-light"
let lightTheme = "card bg-gray-400 w-96 shadow-xl m-4 text-black "
  return (
    <div className={theme == "light" ? lightTheme : darkTheme} onClick={handleNavigation }>
      <figure>
        <img
          className={theme == "light" ? "bg-gradient-to-r from-teal-400 to-blue-500 hover:from-pink-500 hover:to-orange-500 ... rounded-xl mt-2"  : "bg-slate-700 rounded-xl mt-2"}
          src={thumbnail}
          alt="Shoes"
        />
      </figure>
